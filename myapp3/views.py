...
def index(request):
    return render(request, 'myapp3/base1.html')


def get_all_products(request):
    products = models.Product.objects.all()
    return render(request, 'myapp3/products.html', {'products': products})
...
def change_product(request, product_id):
    ...
    return render(request, 'myapp3/change_product.html', {'form': form})
